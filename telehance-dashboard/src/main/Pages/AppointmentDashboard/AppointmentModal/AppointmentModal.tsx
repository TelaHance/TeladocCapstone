            ...
            footer={
                <div className="rainbow-flex rainbow-justify_end">
                    ...
                    <Button
                        ...
                        label="Schedule"
                        variant="brand"
                        onClick={()=>{onConfirm(appointmentDate, chosenDoc, purpose)}}
                    />
                </div>
            }>
            <form id="appointment" noValidate onSubmit={()=>{onConfirm(appointmentDate, chosenDoc, purpose)}}>
                <div className="rainbow-flex rainbow-justify_spread">
                    ...
                    >
                        ...
                        {doctorList && doctorList.map((doctor) =>{
                            const full = 'Dr. ' + doctor.given_name + ' ' + doctor.family_name;
                           return <Option name={doctor.user_id} label={full} icon={<img className={classes['rounded-circle']} src={doctor.picture} width="25" alt=""/>}/>
                        })}
                    </Picklist>
                    <br/>
                    <br/>
