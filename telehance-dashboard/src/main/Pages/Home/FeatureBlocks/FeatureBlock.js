            ...
            <div className={classes["section-bg"]}>
                <div className="">
                    ...
                    <div className={classes['sectionHeader']}>
                        ...
                        <p className={classes['sectionPara']}>TelaHance Health is on a mission to address the full spectrum of health and well-being—not only when people are sick but also throughout their lifelong journeys to achieve better health.</p>
                    </div>
