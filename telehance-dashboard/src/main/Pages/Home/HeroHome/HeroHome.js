        ...
        <div>
          ...
          <div className={classes['section-header']}>
            <h1 data-aos='zoom-y-out'>
              Tela
              <span className={classes['blue-header']}>Hance&nbsp;</span>
            </h1>
            <div>
              <p
              ...
              <div className={classes['btn-container']}>
                ...
                <div
                  className={classes['learn-button']}
                  data-aos='zoom-y-out'
                  data-aos-delay='300'
                >
                  <div>
          ...
          <div>
            <div
              className={classes['heroImageDiv']}
              data-aos='zoom-y-out'
              data-aos-delay='450'
            >
              <div>
                <img
                  ...
                  src={require('assets/online-doctor-flat-design.jpg')}
                  width='500'
                  alt='Hero'
                />
                <svg
